...
- Specification Writer → Solution Architect — Always (always)
- Solution Architect → Engineering Manager — Always (always)
- Engineering Manager → Feature Coder — Always (always)
...
- Code Reviewer → Security Reviewer — If approved (conditional)
- Security Reviewer → Feature Coder — If failed (return (loop back))
- Security Reviewer → Technical Auditor — If passed (conditional)
- Technical Auditor → Feature Coder — If changes required (return (loop back))
- Technical Auditor → Release Notes Author — If approved (conditional)
- Release Notes Author → Release Gatekeeper — Always (always)
- Release Gatekeeper → Feature Coder — If blocked (return (loop back))

Pipeline start: **Specification Writer**
...
- `.github/agents/01-specification-writer.agent.md` — Specification Writer (Product Manager)
- `.github/agents/02-solution-architect.agent.md` — Solution Architect (Architect)
- `.github/agents/03-engineering-manager.agent.md` — Engineering Manager (Engineering Manager)
- `.github/agents/04-feature-coder.agent.md` — Feature Coder (Coder)
- `.github/agents/05-test-author.agent.md` — Test Author (Tester)
- `.github/agents/06-qa-verifier.agent.md` — QA Verifier (QA)
- `.github/agents/07-code-reviewer.agent.md` — Code Reviewer (Code Reviewer)
- `.github/agents/08-security-reviewer.agent.md` — Security Reviewer (Security Auditor)
- `.github/agents/09-technical-auditor.agent.md` — Technical Auditor (Release Reviewer)
- `.github/agents/10-release-notes-author.agent.md` — Release Notes Author (Release Engineer)
- `.github/agents/11-release-gatekeeper.agent.md` — Release Gatekeeper (Release Reviewer)
