...
// authorizes this run against .canon/flows/beta-9de674/identity.json and issues a short-lived
...
function loadIdentity() {
  try {
    ...
    throw new Error(
      "This repository has no .canon/flows/beta-9de674/identity.json. Recompile the package from Canon " +
